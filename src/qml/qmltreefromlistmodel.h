...
class QmlTreeFromListModel : public QAbstractItemModel, public QQmlParserStatus {
    Q_OBJECT
    ...
    QML_NAMED_ELEMENT(TreeFromListModel)
  public:
    QmlTreeFromListModel(QObject* parent = nullptr);
    ~QmlTreeFromListModel() override;
  ...
  private:
    ...
    QmlTreeFromListModel::ColumnRoleMetadata fetchColumnRoleData(
