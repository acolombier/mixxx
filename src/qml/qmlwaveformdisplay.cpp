...
int QmlWaveformDisplay::fromTimerToNextSyncMicros(const PerformanceTimer& timer) {
    // TODO @m0dB Might probably better to use a singleton instead of deriving
    // QmlWaveformDisplay from ISyncTimeProvider and have each keep track of
    // this.
...
int QmlWaveformDisplay::getSyncIntervalTimeMicros() const {
    return 33333;
}
