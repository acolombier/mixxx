...
IF /I "%PLATFORM%"=="arm64" (
    IF DEFINED BUILDENV_RELEASE (
        ...
        SET BUILDENV_NAME=mixxx-deps-2.6-arm64-windows-36b8ec0
        SET BUILDENV_SHA256=41ec7d0d691a03d4f9d57a43cea201814d9722cae1cbdbbca9351889696469bb
    )
) ELSE IF /I "%PLATFORM%"=="x64" (
    IF DEFINED BUILDENV_RELEASE (
        SET BUILDENV_BRANCH=2.6-rel
        SET VCPKG_TARGET_TRIPLET=x64-windows-release
        SET BUILDENV_NAME=mixxx-deps-2.6-x64-windows-rel-2a81b0d
        SET BUILDENV_SHA256=71e240b0dd47f00e19d3955ada822a4242bdcb4f75fb0563cb83efe1f05485ca
    ) ELSE (
        SET BUILDENV_BRANCH=2.6
        SET VCPKG_TARGET_TRIPLET=x64-windows
        SET BUILDENV_NAME=mixxx-deps-2.6-x64-windows-36b8ec0
        SET BUILDENV_SHA256=147feeb3bcbc50ad55a3452184704ab932a6bdfb13c82b00e1c4713101207078
    )
) ELSE (
