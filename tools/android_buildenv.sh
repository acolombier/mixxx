...
if [ "$HOST_ARCH" == "x86_64" ]; then
    if [ -n "${BUILDENV_RELEASE}" ]; then
        ...
        BUILDENV_NAME="mixxx-deps-2.6-arm64-android-rel-c13e699"
        BUILDENV_SHA256="4a6e7a2d83ae2056a89298a0fd6d110d44a4344e3968219dd0c3d34648599233"
    else
        VCPKG_TARGET_TRIPLET="arm64-android"
        BUILDENV_BRANCH="2.7"
        BUILDENV_NAME="mixxx-deps-2.6-arm64-android-c13e699"
        BUILDENV_SHA256="816be142c0873875d4941c77c620467a4c08a821fba7d4c19c9b00468d93e01f"
    fi
else
