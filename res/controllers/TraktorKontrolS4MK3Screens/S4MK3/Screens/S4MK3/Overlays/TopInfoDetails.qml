...
Item {
    ...
    Widgets.ProgressBar {
        ...
        progressBarColorIndicatorLevel: !isPatternPlayer ? colors.colorIndicatorLevelOrange : colors.colorGreenMint
  ...
  // Diverse Elements
    ...
    // fx name
        Text {
            ...
            text: finalLabel
            color: isPatternPlayer ? colors.colorGreenMint : "orange"
            anchors.top: parent.top
            anchors.left: parent.left
