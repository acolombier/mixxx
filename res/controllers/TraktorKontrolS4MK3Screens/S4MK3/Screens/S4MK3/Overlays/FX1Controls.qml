        ...
        Column {
            ...
            Row {
                FXInfoDetails {
                    ...
                    label: settings.fx1pad1label
                    fxUnit: settings.fx1unit
                    effectID: settings.fx1pad1
                    width: 80
                }
                FXInfoDetails {
                    id: bottomInfoDetails2
                    label: settings.fx1pad2label
                    fxUnit: settings.fx1unit
                    effectID: settings.fx1pad2
                    width: 80
                }
                FXInfoDetails {
                    id: bottomInfoDetails3
                    label: settings.fx1pad3label
                    fxUnit: settings.fx1unit
                    effectID: settings.fx1pad3
                    width: 80
                }
                FXInfoDetails {
                    id: bottomInfoDetails4
                    label: settings.fx1pad4label
                    fxUnit: settings.fx1unit
                    effectID: settings.fx1pad4
                    width: 80
                }
            }
            ...
            Row {
                FXInfoDetails {
                    ...
                    label: settings.fx1pad5label
                    fxUnit: settings.fx1unit
                    effectID: settings.fx1pad5
                    width: 80
                }
                FXInfoDetails {
                    id: bottomInfoDetails6
                    label: settings.fx1pad6label
                    fxUnit: settings.fx1unit
                    effectID: settings.fx1pad6
                    width: 80
                }
                FXInfoDetails {
                    id: bottomInfoDetails7
                    label: settings.fx1pad7label
                    fxUnit: settings.fx1unit
                    effectID: settings.fx1pad7
                    width: 80
                }
                FXInfoDetails {
                    id: bottomInfoDetails8
                    label: settings.fx1pad8label
                    fxUnit: settings.fx1unit
                    effectID: settings.fx1pad8
                    width: 80
                }
            }
        }
