...
QtObject {
    ...
    property color lightOrange: "#ffbf00"
  ...
  //--------------------------------------------------------------------------------------------------------------------
    ...
    // RGB
                                         { low1: rgba (200, 0, 0, 255), low2: rgba (245, 120, 10, 255),
                                         mid1: rgba (241, 230, 110, 255), mid2: rgba ( 20, 245, 170, 255),
                                         high1: rgba (170, 255, 255, 255), high2: rgba (215, 240, 255, 255)},
    // Default
    ...
    // RGB 2
                                         { low1: rgba (200, 0, 0, 255), low2: rgba (245, 120, 10, 255),
                                         mid1: rgba (241, 230, 110, 255), mid2: rgba ( 20, 245, 170, 255),
                                         high1: rgba (70, 155, 255, 255), high2: rgba (0, 90, 255, 255) },
    // RGB 3
                                         { low1: rgba (255, 0, 0,191), low2: rgba (255,125, 11,255),
                                         mid1: rgba ( 0,255,162,207), mid2: rgba (153,255,175,255),
                                         high1: rgba ( 89, 97,255,223), high2: rgba (158,189,255,255)},
    // RGB 4
                                         { low1: rgba (255, 0, 0, 191), low2: rgba (255, 125, 11, 255),
                                         mid1: rgba (0, 255, 162, 207), mid2: rgba (155, 255, 155, 223),
                                         high1: rgba (89, 97, 255, 207), high2: rgba (158, 189, 255, 239) },
       // Ultraviolet
                                         { low1: rgba ( 30, 85,170,239), low2: rgba ( 50,100,180,255),
                                         mid1: rgba ( 50,220,255,223), mid2: rgba ( 60,220,255,239),
                                         high1: rgba (200,255,235,239), high2: rgba (210,255,245,255)},
	// Ultraviolet Inverted
                                         { low1: rgba (210,255,245,255), low2: rgba (200,255,235,239),
                                         mid1: rgba ( 60,200,255,239), mid2: rgba ( 50,220,255,223),
                                         high1: rgba ( 50,100,180,255), high2: rgba ( 30, 85,170,239)} ]
  ...
  // 16 Colors Palette (Bright)
    ...
    property variant color09Bright: rgba ( 0, 208, 208, 255)
  ...
  // 16 Colors Palette (Dark)
    ...
    property variant colorBlack66: rgba (16, 16, 16, 255)
  ...
  //this list will be filled with Component.onCompleted() based on musicalKeyColor (see further down)
    property variant musicalKeyBrightColors: []
    ...
    Component.onCompleted: {
        for (var i = 0; i<musicalKeyColors.length; i++) {
            musicalKeyDarkColors.push( darkerColor(musicalKeyColors[i], 0.3) );
            musicalKeyBrightColors.push( darkerColor(musicalKeyColors[i], 1.5) );
        }
        for (var j = 0; j<cueColours.length; j++) {
            cueColoursDark.push( darkerColor(cueColours[j], 0.15) );
        }
    }
}
