...
Item {
    ...
    readonly property int rating: 				(model.dataType == BrowserDataType.Track) ? ((model.rating == "") ? 0 : model.rating ) : 0
  ...
  // container for zebra & track infos
	...
	// track name
        Text {
            ...
            text: (model.dataType == BrowserDataType.Track) ? model.trackName : ""
            font.pixelSize: 20
    ...
    // key
        ...
        Rectangle {
            ...
            visible: (model.dataType == BrowserDataType.Track) && !settings.hideAlbumArt
